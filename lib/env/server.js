...
/** @type {{ production: "prod"; preview: "preview"; development: "dev" }} */
...
/** @type {`${typeof APP_SLUG}:${typeof clientEnv.NEXT_PUBLIC_APP_ENV}`} */
export const redisKeyPrefix = `${APP_SLUG}:${clientEnv.NEXT_PUBLIC_APP_ENV}`;
