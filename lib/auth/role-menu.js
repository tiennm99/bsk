 ...
 * @property {string} href Locale-relative path, e.g. "/dashboard". Sidebar prefixes with locale.
 * @property {string} labelKey Key into the "nav" namespace in messages/{vi,en}.json
 * @property {import("react").ComponentType<{ className?: string }>} icon Icon component from lucide-react
 */
